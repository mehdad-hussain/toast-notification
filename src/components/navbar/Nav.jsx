                      ...
                      className={({ isActive }) =>
                        joinClasses(
                          isActive
                            ...
                            : "text-slate-700 dark:text-gray-300 hover:bg-gray-700",
                          "px-3 py-2 text-sm font-medium rounded-md hover:text-white"
                        )
                      }
                    >
                      Toast Notifications
                ...
                className={({ isActive }) =>
                  joinClasses(
                    isActive
                      ? "text-white bg-gray-900"
                      : "text-slate-700 dark:text-gray-300 hover:bg-gray-700",
                    "block px-3 py-2 text-base font-medium rounded-md hover:text-white"
                  )
                }
              >
                Toast Notifications
